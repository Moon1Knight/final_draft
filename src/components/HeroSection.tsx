...
const HeroSection = () => {
  ...
  return <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-r from-white via-blue-50 to-purple-50">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 py-20 md:py-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <motion.div className="md:col-span-7 z-10" initial="hidden" animate={isLoaded ? "visible" : "hidden"} variants={containerVariants}>
            <motion.h5 className="text-school-orange font-medium mb-2 tracking-wider" variants={itemVariants}>
              WELCOME TO SMART AVENUES GLOBAL SCHOOL
            </motion.h5>
            
            <motion.h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight mb-6 text-gray-900" variants={itemVariants}>
            ...
            <motion.p className="text-lg text-gray-600 mb-8 max-w-xl leading-relaxed" variants={itemVariants}>
            ...
            <motion.div className="flex flex-wrap gap-4" variants={itemVariants}>
              <Button size="lg" className="bg-school-green hover:bg-school-green-dark group transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg rounded-full px-6">
              ...
              <Link to="/contact">
                <Button size="lg" variant="outline" className="border-school-blue text-school-blue hover:bg-school-blue hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md rounded-full px-6">
          ...
          <motion.div className="md:col-span-5 flex justify-center" initial={{
          opacity: 0,
          scale: 0.9
        }} animate={isLoaded ? {
          opacity: 1,
